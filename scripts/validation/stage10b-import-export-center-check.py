...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.16"', 'Stage 11D-1 Migration Startup Guard', 'GARMETIX-11D1-20260622-4116']) and "APP_VERSION = '4.11.16'" in app_version and '<Version>4.11.16</Version>' in csproj)
