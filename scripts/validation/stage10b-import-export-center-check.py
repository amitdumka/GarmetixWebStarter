...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.10"', 'Stage 11B-8 Mantra Local Service Adapter', 'GARMETIX-11B-20260622-4120']) and "APP_VERSION = '4.11.10'" in app_version and '<Version>4.11.10</Version>' in csproj)
