...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.7"', 'Stage 11B-5 Fingerprint Kiosk Punch Guard', 'GARMETIX-11B-20260621-4117']) and "APP_VERSION = '4.11.7'" in app_version and '<Version>4.11.7</Version>' in csproj)
