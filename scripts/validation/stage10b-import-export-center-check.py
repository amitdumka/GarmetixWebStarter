...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.3"', 'Stage 11B Fingerprint Bridge Contract', 'GARMETIX-11B-20260621-4113']) and "APP_VERSION = '4.11.3'" in app_version and '<Version>4.11.3</Version>' in csproj)
