...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.12"', 'Stage 11B-10 Mantra Contract Rehearsal Drill', 'GARMETIX-11B-20260622-4122']) and "APP_VERSION = '4.11.12'" in app_version and '<Version>4.11.12</Version>' in csproj)
