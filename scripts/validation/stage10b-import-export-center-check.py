...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.17"', 'Stage 11D-2 Nuxt UI 4.9 Package Update', 'GARMETIX-11D2-20260622-4117']) and "APP_VERSION = '4.11.17'" in app_version and '<Version>4.11.17</Version>' in csproj)
