...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.13"', 'Stage 11C Face Liveness Readiness Contract', 'GARMETIX-11C-20260622-4113']) and "APP_VERSION = '4.11.13'" in app_version and '<Version>4.11.13</Version>' in csproj)
