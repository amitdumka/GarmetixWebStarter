...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.14"', 'Stage 11C-2 Face Liveness Simulator Bridge', 'GARMETIX-11C-20260622-4114']) and "APP_VERSION = '4.11.14'" in app_version and '<Version>4.11.14</Version>' in csproj)
