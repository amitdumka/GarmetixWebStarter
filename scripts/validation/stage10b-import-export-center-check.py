...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.9"', 'Stage 11B-7 Mantra Enrollment Bridge Wiring', 'GARMETIX-11B-20260621-4119']) and "APP_VERSION = '4.11.9'" in app_version and '<Version>4.11.9</Version>' in csproj)
