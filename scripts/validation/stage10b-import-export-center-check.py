...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.11"', 'Stage 11B-9 Mantra Service Harness', 'GARMETIX-11B-20260622-4121']) and "APP_VERSION = '4.11.11'" in app_version and '<Version>4.11.11</Version>' in csproj)
