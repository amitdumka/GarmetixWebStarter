...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.8"', 'Stage 11B-6 Biometric Enrollment Consent Hardening', 'GARMETIX-11B-20260621-4118']) and "APP_VERSION = '4.11.8'" in app_version and '<Version>4.11.8</Version>' in csproj)
