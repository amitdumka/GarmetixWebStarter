...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.2"', 'Stage 11A Physical Tablet Rehearsal', 'GARMETIX-11A-20260621-4112']) and "APP_VERSION = '4.11.2'" in app_version and '<Version>4.11.2</Version>' in csproj)
