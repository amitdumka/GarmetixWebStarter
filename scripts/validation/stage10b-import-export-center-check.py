...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.6"', 'Stage 11B-4 Local Fingerprint Bridge Template', 'GARMETIX-11B-20260621-4116']) and "APP_VERSION = '4.11.6'" in app_version and '<Version>4.11.6</Version>' in csproj)
