...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.15"', 'Stage 11D Migration Baseline And System Defaults', 'GARMETIX-11D-20260622-4115']) and "APP_VERSION = '4.11.15'" in app_version and '<Version>4.11.15</Version>' in csproj)
