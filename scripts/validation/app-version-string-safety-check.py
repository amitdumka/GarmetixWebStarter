...
add('APP_VERSION remains present', "export const APP_VERSION = '4.10.12'" in text or "export const APP_VERSION = '4.10.13'" in text or "export const APP_VERSION = '4.10.14'" in text or "export const APP_VERSION = '4.10.15'" in text or "export const APP_VERSION = '4.10.16'" in text or "export const APP_VERSION = '4.10.17'" in text or "export const APP_VERSION = '4.10.18'" in text or "export const APP_VERSION = '4.10.19'" in text or "export const APP_VERSION = '4.10.20'" in text or "export const APP_VERSION = '4.10.21'" in text or "export const APP_VERSION = '4.10.22'" in text or "export const APP_VERSION = '4.10.23'" in text or "export const APP_VERSION = '4.10.24'" in text)
