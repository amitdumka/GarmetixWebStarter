...
allowed_versions = [f"export const APP_VERSION = '4.10.{patch}'" for patch in range(12, 32)] + ["export const APP_VERSION = '4.11.0'", "export const APP_VERSION = '4.11.1'", "export const APP_VERSION = '4.11.11'"]
add('APP_VERSION remains present', any(version in text for version in allowed_versions))
add('Stage label preserved', 'Stage 10B Excel Import Export Center' in text or 'Stage 10 Complete Final Acceptance' in text or 'Stage 10G Navigation Menu Coverage' in text or 'Stage 10H Runtime Bug Fix Pack' in text or 'Stage 10I Store Operations Cash Closing Repair' in text or 'Stage 10J Real Excel Import Export Engine' in text or 'Stage 10K Production Operator Acceptance' in text or 'Stage 10L Production Support Pack' in text or 'Stage 10M Production Rehearsal Tracker' in text or 'Stage 11A MAUI Android Attendance Kiosk Shell' in text or 'Stage 11A Android Build Hardening' in text or 'Stage 11B-9 Mantra Service Harness' in text)
