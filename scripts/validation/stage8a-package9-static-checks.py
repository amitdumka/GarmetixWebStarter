...
check("all runtime versions are 4.0.7", versions == {"4.0.7"})
check("assembly and file versions are 4.0.7.0", assembly_match and file_match and assembly_match.group(1) == file_match.group(1) == "4.0.7.0")
check("frontend and backend build codes match", "GARMETIX-8A-20260614-4007" in frontend_version and "GARMETIX-8A-20260614-4007" in backend_version)
