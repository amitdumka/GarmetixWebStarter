...
if 'StartsWith("4."' not in runtime or 'StartsWith("GARMETIX-8"' not in runtime:
    raise SystemExit('Runtime smoke still has stale hard-coded version check')
roadmap = (root / 'docs/planning/CURRENT-ROADMAP.md').read_text()
if 'Stage 8H Package 3 Purchase and Voucher Crash Hotfix / v4.7.2' not in roadmap:
