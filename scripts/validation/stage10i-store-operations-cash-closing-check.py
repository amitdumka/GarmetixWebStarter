...
if not checks[0][1]:
    checks[0] = ('version identity', 'Stage 10J Real Excel Import Export Engine' in app_info and 'GARMETIX-10J-20260620-4125' in app_info and "APP_VERSION = '4.10.25'" in app_version and '<Version>4.10.25</Version>' in csproj)
