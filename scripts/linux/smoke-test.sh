...
EXPECTED_VERSION="${GARMETIX_EXPECTED_VERSION:-4.10.4}"
EXPECTED_BUILD_CODE="${GARMETIX_EXPECTED_BUILD_CODE:-GARMETIX-9D-20260619-4104}"
...
required = {'BACKEND_UNIT_TESTS','DASHBOARD_HOME_CONTRACT','FRONTEND_BUILD','FRONTEND_SMOKE','DOCKER_COMPOSE_BUILD','DOCKER_HEALTH','FRONTEND_ROUTE_ACCESS_AUDIT','DOCKER_ACCEPTANCE_DRILL','SECRET_HYGIENE_AUDIT','FRONTEND_HYDRATION_GUARD','BACKUP_RESTORE_SAFETY','PERMISSION_ROLE_ACCEPTANCE','PRINT_PDF_ACCEPTANCE','SMTP_DELIVERY_ACCEPTANCE','LICENSE_SAAS_ACTIVATION','ATTENDANCE_CORE_ACCEPTANCE','AUTHENTICATED_API_SMOKE'}
