...
version_41013 = version_41013 or (all(token in app_info for token in ['Version = "4.11.19"', 'Stage 11D-4 Factory Reset Admin Identity Fix', 'GARMETIX-11D4-20260624-4119']) and "APP_VERSION = '4.11.19'" in app_version and '<Version>4.11.19</Version>' in csproj)
