...
add(
    ...
    and "4.11.19-stage11d4-factory-reset-admin-identity-fix" in bridge_project
...
add(
    ...
    and '<Version>4.11.19</Version>' in mock_mantra_project
    and "4.11.19-stage11d4-factory-reset-admin-identity-fix" in mock_mantra_project
...
add(
    ...
    and "Stage 11C-2 Face Liveness Simulator Bridge" in readme
    and "Stage 11C-2 Face Liveness Simulator Bridge" in roadmap
