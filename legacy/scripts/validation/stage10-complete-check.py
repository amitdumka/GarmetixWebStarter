...
allowed_versions = [f"APP_VERSION = '4.10.{patch}'" for patch in range(13, 32)] + ["APP_VERSION = '4.11.0'", "APP_VERSION = '4.11.1'", "APP_VERSION = '4.11.14'", "APP_VERSION = '4.11.19'", "APP_VERSION = '4.11.19'"]
