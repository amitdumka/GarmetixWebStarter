...
EXPECTED_VERSION="${GARMETIX_EXPECTED_VERSION:-4.12.69}"
EXPECTED_BUILD_CODE="${GARMETIX_EXPECTED_BUILD_CODE:-GARMETIX-11D154-20260703-4269}"
...
required = {'BACKEND_UNIT_TESTS','DASHBOARD_HOME_CONTRACT','FRONTEND_BUILD','FRONTEND_SMOKE','DOCKER_COMPOSE_BUILD','DOCKER_HEALTH','FRONTEND_ROUTE_ACCESS_AUDIT','DOCKER_ACCEPTANCE_DRILL','SECRET_HYGIENE_AUDIT','FRONTEND_HYDRATION_GUARD','BACKUP_RESTORE_SAFETY','PERMISSION_ROLE_ACCEPTANCE','PRINT_PDF_ACCEPTANCE','SMTP_DELIVERY_ACCEPTANCE','LICENSE_SAAS_ACTIVATION','ATTENDANCE_CORE_ACCEPTANCE','TODAYS_DASHBOARD_ACCEPTANCE','AUTHENTICATED_API_SMOKE'}
