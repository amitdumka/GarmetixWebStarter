...
- Standard Codex workspace: `D:\AIArea\Codex\GarmetixWebStarter`
- Active branch for Codex-owned work: `version6`
- Deploy modular SRP site from this D-drive Codex workspace.
...
- Do not use it as the normal deploy path after the D workspace is verified.
