...
namespace Garmetix.Infrastructure.Data.Migrations
{
    ...
    public partial class AddMissingModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"PurchaseInvoiceImportFiles\", \"TenantSubscriptions\", \"DigitalBillCampaignRecipients\", \"EmployeeAttendanceShiftRules\", \"SaaSPlans\", \"WhatsAppProviderSettings\", \"DotMatrixPrintQueueEntries\", \"DigitalInvoiceEvents\", \"PurchaseInvoiceImportVendorProfiles\", \"DigitalInvoices\", \"WhatsAppMessageLogs\", \"DotMatrixPrintSettings\", \"SaaSTokens\", \"StoreReviewSettings\", \"PurchaseInvoiceImportLines\", \"PosHeldBills\", \"DigitalBillCampaigns\", \"CustomerFeedback\", \"PurchaseInvoiceImportBatches\", \"InvoiceAdBanners\", \"SaaSClients\" CASCADE;");
            migrationBuilder.Sql("DROP INDEX IF EXISTS \"IX_DigitalBillCampaigns_CompanyId_StoreId_Status_CreatedAt\", \"IX_DigitalBillCampaigns_CompanyId_Segment_FromDate_ToDate\", \"IX_TenantSubscriptions_CompanyId\", \"IX_PurchaseInvoiceImportBatches_Sha256Hash\", \"IX_PurchaseInvoiceImportBatches_CompanyId_VendorGstinFinal_Sup~\", \"IX_DigitalInvoiceEvents_CompanyId_DigitalInvoiceId_EventAt\", \"IX_PurchaseInvoiceImportLines_CompanyId_ProductId\", \"IX_WhatsAppProviderSettings_CompanyId_StoreId\", \"IX_Stocks_CompanyId_StoreId_Barcode\", \"IX_PurchaseInvoices_CompanyId_StoreId_VendorId_OnDate\", \"IX_StoreReviewSettings_CompanyId_StoreId\", \"IX_DotMatrixPrintQueueEntries_CompanyId_StoreId_BusinessDate_S~\", \"IX_PurchaseInvoiceImportLines_BatchId\", \"IX_SaaSTokens_SaaSClientId\", \"IX_EmployeeAttendanceShiftRules_CompanyId_StoreId_Active_Prior~\", \"IX_DotMatrixPrintQueueEntries_SourceType_SourceId_ActionType\", \"IX_DigitalBillCampaignRecipients_CompanyId_CustomerMobile_Crea~\", \"IX_PurchaseInvoiceImportVendorProfiles_CompanyId_VendorGstin\", \"IX_CustomerFeedback_CompanyId_DigitalInvoiceId\", \"IX_InvoiceItems_CompanyId_InvoiceId\", \"IX_DigitalInvoices_CompanyId_StoreId_InvoiceDate\", \"IX_DotMatrixPrintQueueEntries_Status_CreatedAt\", \"IX_DotMatrixPrintSettings_CompanyId_StoreId\", \"IX_DotMatrixPrintQueueEntries_DeduplicationKey\", \"IX_PurchaseInvoices_CompanyId_StoreId_InwardDate\", \"IX_EmployeeAttendanceShiftRules_AttendanceShiftId\", \"IX_InvoiceAdBanners_CompanyId_StoreId_Position_IsActive\", \"IX_PosHeldBills_CompanyId_StoreGroupId_StoreId_Status_HeldAt\", \"IX_WhatsAppMessageLogs_CompanyId_StoreId_Status_CreatedAt\", \"IX_CustomerFeedback_CompanyId_StoreId_SubmittedAt\", \"IX_PurchaseInvoiceImportLines_CompanyId_BatchId_LineNumber\", \"IX_PosHeldBills_CompanyId_ClientHeldBillId\", \"IX_Stocks_CompanyId_StoreId_ProductId_IsOFB\", \"IX_DigitalInvoiceEvents_CompanyId_StoreId_EventType_EventAt\", \"IX_DigitalInvoices_PublicToken\", \"IX_EmployeeAttendanceShiftRules_CompanyId_StoreId_EmployeeId_A~\", \"IX_DigitalInvoices_CompanyId_InvoiceId_InvoiceType\", \"IX_PurchaseInvoiceImportBatches_CompanyId_StoreId_Status_Creat~\", \"IX_Companies_SaaSClientId\", \"IX_SaaSTokens_SaaSPlanId\", \"IX_DigitalBillCampaignRecipients_CompanyId_CampaignId_Status\", \"IX_EmployeeAttendanceShiftRules_EmployeeId\", \"IX_PurchaseInvoiceImportFiles_BatchId\", \"IX_WhatsAppProviderSettings_CompanyId_StoreId_IsEnabled_AutoSe~\", \"IX_PurchaseInvoiceImportVendorProfiles_CompanyId_VendorId\", \"IX_PurchaseInvoiceImportBatches_PostedPurchaseInvoiceId\", \"IX_PurchaseInvoiceImportFiles_CompanyId_BatchId_FileKind\", \"IX_PurchaseInvoiceImportFiles_Sha256Hash\", \"IX_WhatsAppMessageLogs_CompanyId_DigitalInvoiceId\", \"IX_PurchaseInvoices_CompanyId_StoreId_OnDate\" CASCADE;");
            migrationBuilder.Sql("ALTER TABLE \"SalesInvoices\" DROP COLUMN IF EXISTS \"Remarks\" CASCADE; ALTER TABLE \"Companies\" DROP COLUMN IF EXISTS \"SaaSClientId\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"AttendanceMode\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"BreakEndMinutes\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"BreakStartMinutes\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"CountBreakAsWork\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"HasBreak\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"RequiredSessionsForFullDay\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"RequiredSessionsForHalfDay\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"RequiresBreakPunch\" CASCADE; ALTER TABLE \"AttendanceShifts\" DROP COLUMN IF EXISTS \"ShiftCategory\" CASCADE; ALTER TABLE \"Attendance\" DROP COLUMN IF EXISTS \"BreakInTime\" CASCADE; ALTER TABLE \"Attendance\" DROP COLUMN IF EXISTS \"BreakOutTime\" CASCADE; ");
