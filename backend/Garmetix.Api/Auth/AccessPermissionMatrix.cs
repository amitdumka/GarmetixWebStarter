...
public static class AccessPermissionMatrix
{
    ...
    [
        ...
        Profile(Role(LoginRole.RemoteAccountant), false, false, false, [GarmetixPolicies.Accounting, "Reports", "GST"], "Accounting review and entry without global edit/delete rights."),
        Profile(Role(LoginRole.StoreManager), false, false, false, [GarmetixPolicies.Billing, GarmetixPolicies.Inventory, GarmetixPolicies.Purchase, GarmetixPolicies.Accounting, GarmetixPolicies.Hr, "Reports"], "Store views and new entries; no Admin, edit, or delete rights."),
