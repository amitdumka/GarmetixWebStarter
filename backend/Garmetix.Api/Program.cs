...
builder.Services.AddScoped<VyaparCreditNoteImportService>();
...
builder.Services.AddScoped<FinalAccountsPostingAdapterService>();
...
builder.Services.AddScoped<IFinalAccountsPostingAdapter, SalesCreditNoteAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, PurchaseInvoiceAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, PurchaseInvoiceCancellationAdapter>();
...
builder.Services.AddScoped<IFinalAccountsPostingAdapter, PayrollDraftFinalizationAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, SalaryPaySlipFinalizationAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, SalaryPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, PayrollStatutoryPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, GstPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, TdsPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, GstReturnSettlementAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, TailoringIncomeAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, TailoringVendorCostAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, TailoringCustomerReceiptAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, CustomerAdvanceApplicationAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, VendorAdvanceApplicationAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, OtherIncomeReceiptAdapter>();
...
builder.Services.AddScoped<IFinalAccountsPostingAdapter, VendorPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, VoucherReceiptAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, VoucherPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, VoucherExpenseAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, CashVoucherReceiptAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, CashVoucherPaymentAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, CashVoucherExpenseAdapter>();
builder.Services.AddScoped<IFinalAccountsPostingAdapter, BankCashTransferAdapter>();
...
app.MapVyaparCreditNoteImportEndpoints();
