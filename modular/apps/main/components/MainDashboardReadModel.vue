  ...
  <section class="space-y-4">
    ...
    <section class="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
      <div class="border border-default bg-muted/10 p-4">
        <h3 class="text-base font-semibold">{{ primaryTitle }}</h3>
      ...
      <div class="space-y-4">
        <div class="border border-default bg-muted/10 p-4">
          <h3 class="text-base font-semibold">{{ secondaryTitle }}</h3>
...
const primaryRows = computed(() => readArray(data.value, props.primaryKeys))
const secondaryRows = computed(() => readArray(data.value, props.secondaryKeys))
const signals = computed(() => readArray(data.value, props.signalKeys))
const trend = computed(() => readArray(data.value, props.trendKeys))
