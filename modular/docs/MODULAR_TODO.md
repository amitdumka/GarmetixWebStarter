...
- 13F.3 next: add guarded Admin writable/live preflight for backup restore, factory reset, license generation/activation and import/export commit without executing dangerous mutations by default.
