...
const backupSource = read(join(repoRoot, 'backend/Garmetix.Api/Backup/BackupEndpoints.cs'))
const factoryResetSource = read(join(repoRoot, 'backend/Garmetix.Api/Backup/FactoryResetEndpoints.cs'))
const licenseEndpointSource = read(join(repoRoot, 'backend/Garmetix.Api/Licensing/LicenseEndpoints.cs'))
const licenseDtoSource = read(join(repoRoot, 'backend/Garmetix.Api/Licensing/LicenseDtos.cs'))
const importExportSource = read(join(repoRoot, 'backend/Garmetix.Api/ImportExport/ImportExportEndpoints.cs'))
const adminSource = [
  'app.vue',
  ...
  'utils/admin-api.ts'
].map(file => read(join(repoRoot, 'frontend/modular/apps/admin', file))).join('\n')
