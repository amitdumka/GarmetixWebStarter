...
const backendDtoPath = join(repoRoot, 'backend/Garmetix.Api/Billing/BillingDtos.cs')
const saleContractPath = join(repoRoot, 'frontend/modular/apps/pos/utils/sale-contract.ts')
const returnContractPath = join(repoRoot, 'frontend/modular/apps/pos/utils/return-contract.ts')
