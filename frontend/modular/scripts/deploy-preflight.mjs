...
const modularRoot = join(repoRoot, 'frontend/modular')
...
add(existsSync(join(repoRoot, 'backend/Garmetix.Api/Garmetix.Api.csproj')), 'Shared API project exists')
...
for (const relativePath of [
  ...
  ...apps.map((app) => `frontend/modular/deploy/${app.deployScript}`)
]) {
