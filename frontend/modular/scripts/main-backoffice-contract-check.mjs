...
const dashboardDtoPath = join(repoRoot, 'backend/Garmetix.Api/Dashboard/DashboardDtos.cs')
const billingDtoPath = join(repoRoot, 'backend/Garmetix.Api/Billing/BillingDtos.cs')
const purchaseDtoPath = join(repoRoot, 'backend/Garmetix.Api/Purchase/PurchaseDtos.cs')
const stockReportDtoPath = join(repoRoot, 'backend/Garmetix.Api/Inventory/StockReportDtos.cs')
const productLookupDtoPath = join(repoRoot, 'backend/Garmetix.Api/ProductLookup/ProductLookupDtos.cs')
const workspaceDtoPath = join(repoRoot, 'backend/Garmetix.Api/Workspace/WorkspaceDtos.cs')
...
const expectedContracts = [
  ...
  },
  {
    ...
    keys: ['id', 'invoiceNumber', 'onDate', 'customerName', 'customerMobileNumber', 'billAmount', 'paidAmount', 'balanceAmount', 'invoiceStatus', 'paymentMode', 'digitalBillId', 'digitalBillPublicPath', 'digitalBillPublicToken', 'digitalBillIsActive', 'digitalBillWhatsAppStatus', 'digitalBillOpenCount', 'digitalBillPdfDownloadCount', 'digitalBillReviewClickCount', 'digitalBillLastWhatsAppSentAt', 'remarks']
  },
  {
  ...
  },
  {
    ...
    keys: ['id', 'invoiceNumber', 'inwardNumber', 'onDate', 'inwardDate', 'supplierInvoiceDate', 'dueDate', 'vendorId', 'vendorName', 'vendorGstin', 'billAmount', 'paidAmount', 'balanceAmount', 'frightAmount', 'itemCount', 'quantity', 'invoiceStatus', 'paymentMode', 'hasImportProof', 'importBatchId']
  },
  {
