...
const sourceFiles = {
  ...
  shell: read(join(modularRoot, 'packages/shared-ui/components/ModularAppShell.vue')),
  routeRegistry: read(join(modularRoot, 'config/routes.ts')),
...
const backendFiles = {
  backup: read(join(repoRoot, 'backend/Garmetix.Api/Backup/BackupEndpoints.cs')),
  factoryReset: read(join(repoRoot, 'backend/Garmetix.Api/Backup/FactoryResetEndpoints.cs')),
  runtime: read(join(repoRoot, 'backend/Garmetix.Api/Production/RuntimeDiagnosticsEndpoints.cs')),
  license: read(join(repoRoot, 'backend/Garmetix.Api/Licensing/LicenseEndpoints.cs')),
  messages: read(join(repoRoot, 'backend/Garmetix.Api/Messages/ApplicationMessageLogEndpoints.cs')),
  importExport: read(join(repoRoot, 'backend/Garmetix.Api/ImportExport/ImportExportEndpoints.cs')),
  dataConsistency: read(join(repoRoot, 'backend/Garmetix.Api/Validation/DataConsistencyEndpoints.cs')),
  productionReadiness: read(join(repoRoot, 'backend/Garmetix.Api/Production/ProductionReadinessEndpoints.cs')),
  migrations: read(join(repoRoot, 'backend/Garmetix.Api/Database/DatabaseMigrationEndpoints.cs')),
  access: read(join(repoRoot, 'backend/Garmetix.Api/Auth/AccessMatrixEndpoints.cs')),
  users: read(join(repoRoot, 'backend/Garmetix.Api/Auth/UserManagementEndpoints.cs')),
  onboarding: read(join(repoRoot, 'backend/Garmetix.Api/Onboarding/ClientOnboardingEndpoints.cs')),
  release: read(join(repoRoot, 'backend/Garmetix.Api/Release/ReleaseStabilizationEndpoints.cs'))
}
...
function assertSourceGuards() {
  ...
  assertIncludes('Admin shell includes production readiness route', adminShellSource, "/production-readiness")
