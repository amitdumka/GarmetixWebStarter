...
const apps = [
  {
    ...
    deploy: 'bash frontend/modular/deploy/main-static-deploy.sh'
  },
  {
    key: 'pos',
    label: 'POS',
    ...
    deploy: 'bash frontend/modular/deploy/pos-static-deploy.sh'
  },
  {
    key: 'hr',
    label: 'HR',
    ...
    deploy: 'bash frontend/modular/deploy/hr-static-deploy.sh'
  },
  {
    key: 'ai-sense',
    label: 'AI Sense',
    ...
    deploy: 'bash frontend/modular/deploy/ai-sense-static-deploy.sh'
  },
  {
    key: 'books',
    label: 'Books',
    ...
    deploy: 'bash frontend/modular/deploy/books-static-deploy.sh'
  },
  {
    key: 'admin',
    label: 'Admin/SaaS',
    ...
    deploy: 'bash frontend/modular/deploy/admin-static-deploy.sh'
  }
]
