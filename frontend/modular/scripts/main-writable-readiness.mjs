...
const billingDtoSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Billing/BillingDtos.cs'), 'utf8')
const billingEndpointSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Billing/BillingEndpoints.cs'), 'utf8')
const purchaseDtoSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Purchase/PurchaseDtos.cs'), 'utf8')
const purchaseEndpointSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Purchase/PurchaseEndpoints.cs'), 'utf8')
const stockOperationDtoSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Inventory/StockOperationDtos.cs'), 'utf8')
const stockOperationEndpointSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Inventory/StockOperationEndpoints.cs'), 'utf8')
const stockReportEndpointSource = readFileSync(join(repoRoot, 'backend/Garmetix.Api/Inventory/StockReportEndpoints.cs'), 'utf8')
