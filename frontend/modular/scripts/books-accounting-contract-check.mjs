...
const accountingDtoPath = join(repoRoot, 'backend/Garmetix.Api/Accounting/AccountingDtos.cs')
const gstReturnDtoPath = join(repoRoot, 'backend/Garmetix.Api/GstReturns/GstReturnDtos.cs')
const gstReportDtoPath = join(repoRoot, 'backend/Garmetix.Api/GstReturns/GstReportDtos.cs')
const accountingEndpointsPath = join(repoRoot, 'backend/Garmetix.Api/Accounting/AccountingEndpoints.cs')
...
const requiredPageUsages = [
  {
    ...
    tokens: ['accounting/trial-balance', 'ledgerName', 'closingDebit', 'closingCredit']
  },
  {
    label: 'banking.vue',
    path: join(modularRoot, 'apps/books/pages/banking.vue'),
    tokens: ['bank-accounts', 'accounting/bank-transactions', 'cheque-logs', 'vendor-bank-accounts', 'bank-account-details', 'accountHolderName', 'chequeNumber']
  },
  {
    label: 'ledgers.vue',
