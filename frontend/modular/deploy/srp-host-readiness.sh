...
Usage:
  bash frontend/modular/deploy/srp-host-readiness.sh
  bash frontend/modular/deploy/srp-host-readiness.sh --local-only
  bash frontend/modular/deploy/srp-host-readiness.sh --install-remote-packages
