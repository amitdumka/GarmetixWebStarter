export default defineNuxtConfig({
  ...
  app: {
    baseURL: process.env.GARMETIX_NUXT_BASE_URL || process.env.NUXT_PUBLIC_GARMETIX_POS_BASE_PATH || '/',
    head: {
      title: 'Garmetix POS',
  ...
  runtimeConfig: {
    public: {
      ...
      appUrls: {
        ...
        NUXT_PUBLIC_GARMETIX_POS_URL: process.env.NUXT_PUBLIC_GARMETIX_POS_URL || process.env.NUXT_PUBLIC_POS_WEB_URL || 'http://localhost:3101',
