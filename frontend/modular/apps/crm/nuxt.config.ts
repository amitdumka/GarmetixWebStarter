export default defineNuxtConfig({
  ...
  app: {
    baseURL: process.env.GARMETIX_NUXT_BASE_URL || process.env.NUXT_PUBLIC_GARMETIX_CRM_BASE_PATH || '/',
    head: {
      title: 'Garmetix CRM',
  ...
  runtimeConfig: {
    public: {
      ...
      appUrls: {
        ...
        NUXT_PUBLIC_GARMETIX_CRM_URL: process.env.NUXT_PUBLIC_GARMETIX_CRM_URL || process.env.NUXT_PUBLIC_CRM_WEB_URL || 'http://localhost:3106',
