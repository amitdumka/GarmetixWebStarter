<template>
  <section class="garmetix-page-stack">
      ...
      <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p class="garmetix-dashboard-subtitle">
            Payment, receipt and expense vouchers with ledger and bank posting handled by the API. Accountants select the visible ledger only.
          </p>
        </div>
    ...
    <UModal
      ...
      :title="formMode === 'edit' ? 'Edit Voucher' : 'New Voucher'"
      description="Voucher number is generated by store and month. Linked party details are resolved during save."
      :ui="{ content: 'w-[calc(100vw-2rem)] sm:max-w-5xl lg:max-w-6xl' }"
    >
      <template #body>
...
async function refresh() {
  ...
  try {
    ...
    if (!formOpen.value && (!form.ledgerId || !form.employeeId)) seedDefaultFormValues()
