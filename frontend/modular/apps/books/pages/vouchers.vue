<template>
  <section class="garmetix-page-stack">
    ...
    <UModal v-model:open="formOpen" :title="formMode === 'edit' ? 'Edit Voucher' : 'New Voucher'" description="Voucher number is generated by store and month. Linked party details are resolved during save.">
      <template #body>
