<template>
  <section class="mx-auto max-w-xl garmetix-section-card">
    <div class="mb-5">
      <p class="garmetix-kicker"><UIcon name="i-lucide-landmark" class="size-4" /> Books access</p>
    ...
    <form class="space-y-4" @submit.prevent="submit">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <UButton to="/" color="neutral" variant="ghost">Back to Books home</UButton>
      </div>
    </form>
  </section>
</template>
...
useHead({ title: 'Login - Garmetix Books' })
