export default defineNuxtConfig({
  ...
  app: {
    baseURL: process.env.GARMETIX_NUXT_BASE_URL || process.env.NUXT_PUBLIC_GARMETIX_INVENTORY_BASE_PATH || '/',
    head: {
  ...
  runtimeConfig: {
    public: {
      ...
      appUrls: {
        ...
        NUXT_PUBLIC_GARMETIX_INVENTORY_URL: process.env.NUXT_PUBLIC_GARMETIX_INVENTORY_URL || process.env.NUXT_PUBLIC_INVENTORY_WEB_URL || 'http://localhost:3107',
