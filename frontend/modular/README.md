...
This stage creates the folder base and safe project shells. The actual page migration should happen module by module from `frontend/legacy/garmetix-web` into these apps.

Version5 Stage 12 onward frontend changes should stay inside this `frontend/modular/` folder. The `legacy/` folder is the Version4/Stage 11 reference and fallback until modular apps reach parity.
