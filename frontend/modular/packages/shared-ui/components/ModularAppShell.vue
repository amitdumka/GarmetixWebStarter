...
const localMenus: Record<FrontendAppId, MenuGroup[]> = {
  main: [
    ...
    { key: 'sales', label: 'Sales', items: [
      ...
      { id: 'invoice-book-adjustment', label: 'Invoice Books Adjustment', href: '/billing/invoice-book-adjustment', icon: 'i-lucide-calendar-cog' }
    ] },
    { key: 'purchase', label: 'Purchase', items: [
      ...
      { id: 'purchase-import-acceptance', label: 'Import Acceptance', href: '/purchase/import-acceptance', icon: 'i-lucide-clipboard-check' },
  ...
  books: [
    { key: 'accounting', label: 'Accounting', items: [
      ...
      { id: 'day-book', label: 'Day Book', href: '/day-book', icon: 'i-lucide-book-open-check' },
    ...
    { key: 'gst', label: 'GST & Taxes', items: [
      ...
      { id: 'gst-tax-itc-register', label: 'ITC Register', href: '/gst-tax-itc-register', icon: 'i-lucide-scroll-text' },
      { id: 'gst-tax-einvoice-ewaybill', label: 'E-Invoice & E-Way Bill', href: '/gst-tax-einvoice-ewaybill', icon: 'i-lucide-qr-code' },
