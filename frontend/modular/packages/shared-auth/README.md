...
This package will gradually receive the reusable parts of `frontend/legacy/garmetix-web/composables/useAuth.ts`, `useWorkspace.ts`, and permission helpers from `useAccessControl.ts`.
