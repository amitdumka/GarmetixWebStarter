...
- Keep all Stage 13 work under `frontend/modular/` unless a future stage explicitly needs backend hardening.
...
Generated files are written under `frontend/modular/docs/generated/` and ignored by git.
