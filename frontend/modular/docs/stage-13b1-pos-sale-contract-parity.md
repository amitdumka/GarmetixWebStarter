...
From the `frontend/modular/` folder:
...
- Added `frontend/modular/apps/pos/utils/sale-contract.ts`.
...
- Added `frontend/modular/scripts/pos-sale-contract-check.mjs` to compare those manifests with `backend/Garmetix.Api/Billing/BillingDtos.cs`.
