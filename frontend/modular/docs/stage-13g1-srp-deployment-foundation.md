...
- `frontend/modular/.env.example` documents the base path variables and SRP config location.
- `frontend/modular/deploy/README.md` documents SRP commands.
- `frontend/modular/scripts/validate-structure.mjs` requires the SRP deploy files.
...
- `frontend/modular/scripts/run-bash-script.mjs` chooses Git Bash on Windows or normal bash on Linux/macOS for npm deploy commands.
