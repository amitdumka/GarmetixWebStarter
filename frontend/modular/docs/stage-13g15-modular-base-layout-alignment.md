...
- `frontend/legacy/garmetix-web/components/AppShell.vue`
- `frontend/legacy/garmetix-web/app.config.ts`
- `frontend/legacy/garmetix-web/assets/css/main.css`
- `frontend/legacy/garmetix-web/public/*`
