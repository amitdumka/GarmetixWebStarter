...
- New modular frontend work remains under `frontend/modular/`.
...
| Secret scan | Standard secret-pattern scan against `package.json` and `frontend/modular/` | Passed |
...
- `frontend/modular/docs/stage-12h1-deployment-split-guide.md`
- `frontend/modular/docs/stage-12h2-all-app-validation.md`
- `frontend/modular/docs/stage-12h3-deploy-preflight.md`
- `frontend/modular/docs/stage-12h4-host-deployment-notes.md`
- `frontend/modular/docs/stage-12h5-release-checklist.md`
- `frontend/modular/docs/stage-12h6-deployment-acceptance.md`
- `frontend/modular/deploy/README.md`
