...
- `frontend/modular/config/routes.ts`: route ownership and fallback URL helpers.
- `frontend/modular/config/apps.ts`: app target definitions and env keys.
- `frontend/modular/packages/shared-ui/src/index.ts`: shared shell model and route grouping helpers.
- `frontend/modular/apps/*/app.vue`: shell screens consuming the shared model.
