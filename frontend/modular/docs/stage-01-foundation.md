...
- Created `frontend/modular/` as the new frontend workspace.
...
Move screens from `frontend/legacy/garmetix-web/pages` into modular apps module by module:

1. Extract shared API calls into `frontend/modular/packages/shared-api`.
2. Extract shared auth/token/permission checks into `frontend/modular/packages/shared-auth`.
