...
Stage 12B should start POS extraction with real pages under `frontend/modular/apps/pos`, beginning with login/session wiring and the counter dashboard shell.
