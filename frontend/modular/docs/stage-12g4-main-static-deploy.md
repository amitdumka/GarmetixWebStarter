...
- `frontend/modular/deploy/main-static-deploy.sh`
- `npm --prefix modular run deploy:main`
- Main Back Office deployment notes in `frontend/modular/deploy/README.md`
- Main deploy environment examples in `frontend/modular/.env.example`
