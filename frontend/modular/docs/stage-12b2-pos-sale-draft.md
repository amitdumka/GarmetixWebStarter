...
Stage 12B.2 starts the real sale invoice extraction in `frontend/modular/apps/pos/pages/sale.vue`.

## What Changed

- Added a central modular version marker at `frontend/modular/config/version.ts`.
