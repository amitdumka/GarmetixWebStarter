...
| --- | --- | --- |
| Main | `frontend/modular/apps/main` | Back office, dashboards, purchase, inventory, reports, store operations, customers. |
| POS | `frontend/modular/apps/pos` | Sale screen, barcode billing, returns, off-book counter flows, day open/day close. |
| HR | `frontend/modular/apps/hr` | Employees, attendance, monthly attendance, payroll, salary payments, kiosk devices. |
| Books | `frontend/modular/apps/books` | Accounting, ledgers, vouchers, petty cash, banking, GST, audit-facing finance. |
| AI Sense | `frontend/modular/apps/ai-sense` | Sales, purchase, profit, stock risk, vendor, customer, daily and monthly analytics. |
| Admin | `frontend/modular/apps/admin` | Company setup, users, roles, permissions, license, health, logs, deployment readiness. |
...
Prompt compatibility aliases are also listed in `frontend/modular/.env.example`.
