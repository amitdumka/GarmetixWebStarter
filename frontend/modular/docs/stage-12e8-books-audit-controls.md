...
- `frontend/modular/apps/books/pages/financial-year-locks.vue`
- `frontend/modular/apps/books/pages/audit.vue`
- `frontend/modular/apps/books/pages/message-logs.vue`
