...
This stage keeps the work inside `frontend/modular/apps/pos` and reuses the existing ASP.NET Core billing API. It does not change the legacy app, backend endpoints, or database schema.
