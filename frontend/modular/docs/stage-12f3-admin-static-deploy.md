...
- `frontend/modular/deploy/admin-static-deploy.sh`
- `npm --prefix modular run deploy:admin`
- Admin deployment notes in `frontend/modular/deploy/README.md`
- Admin deploy environment examples in `frontend/modular/.env.example`
...
Stage 12G.1 should begin the Main Back Office modular cleanup by auditing what remains in `frontend/modular/apps/main`, documenting route ownership gaps, and preparing the first safe route-level optimization pass.
