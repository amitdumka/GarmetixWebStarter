...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x020002da, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001bd2, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001bd1, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [945 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x021cc56ab6e75274, ; from name: libaot-Swalekha.Mobile.dll.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.81_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.107_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.28_name, ; name: libaot-Syncfusion.Maui.Toolkit.dll.so
		ptr null; void* handle
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Net.Security.dll.so
		ptr null; void* handle
	}, ; 86
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Syncfusion.Maui.Toolkit.resources.dll.so
		ptr null; void* handle
	}, ; 127
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.57_name, ; name: libaot-Xamarin.Google.Crypto.Tink.Android.dll.so
		ptr null; void* handle
	}, ; 142
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3ebce15f68332d17, ; from name: aot-Swalekha.Mobile.dll.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5db1e3ff231d53d9, ; from name: Swalekha.Mobile
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x77fbcf1365b830e8, ; from name: Swalekha.Mobile.dll.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7bcee3d93ad22fbb, ; from name: libaot-Swalekha.Mobile.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x800190230bfa95ec, ; from name: Swalekha.Mobile.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x80de89f64c66a74e, ; from name: aot-Swalekha.Mobile
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9704a2648582bcce, ; from name: libaot-Swalekha.Mobile
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf47263b9115c5915, ; from name: aot-Swalekha.Mobile.so
		i64 u0x021cc56ab6e75274, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Swalekha.Mobile.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"in.aadwikafashion.swalekha\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-Swalekha.Mobile.dll.so\00", align 16
...
@.DSOCacheEntry.28_name = private unnamed_addr constant [38 x i8] c"libaot-Syncfusion.Maui.Toolkit.dll.so\00", align 16
@.DSOCacheEntry.29_name = private unnamed_addr constant [48 x i8] c"libaot-Syncfusion.Maui.Toolkit.resources.dll.so\00", align 16
...
@.DSOCacheEntry.57_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 16
...
@.DSOCacheEntry.81_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 16
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.Security.dll.so\00", align 16
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
